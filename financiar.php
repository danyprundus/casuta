                        ...
                        <form role="form" id="financiarForm">
                            ...
                            <div class="panel panel-primary retragere hide  operatiune">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <?php
                                        $builder->outputMonetar($finance->financeRetragereOptions(),"retragere");
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-primary depunere hide  operatiune">
                                <div class="panel-heading">
                                    Depunere
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <?php
                                        $builder->outputMonetar($finance->financeDepunereBancaOptions(),"depunere");
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-primary faraDocumente hide  operatiune">
                                <div class="panel-heading">
                                    Fara Documente
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <?php
                                        $builder->outputMonetar($finance->financeFaraDocumentOptions(),"faradocumente");
                                        ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-primary baniproprii hide  operatiune">
                                <div class="panel-heading">
                                  Bani Proprii
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <?php
                                        $builder->outputMonetar($finance->financeBaniPropriiOptions(),"baniproprii");
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-primary retragerebaniproprii hide  operatiune">
                                <div class="panel-heading">
                                  Retragere Bani Proprii
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <?php
                                        $builder->outputMonetar($finance->financeRetragereBaniPropriiOptions(),"retragerebaniproprii");
                                        ?>
                                    </div>
                                </div>
                            </div>
    ...
    <table class="table table-bordered table-responsive table-striped" >
        ...
        if($admin==1){
            ...
            for($i=1;  $i<=$numberDays;$i++):
                ...
                ?>
                <tr>
                    <td><a href='financiar.php?viewdate=1&admin=1&date=<?=$date?>'><?=$i?></a></td>
                    <td><?=$zetInfo[$key];?></td>
                    <td><?=$facturaInfo[$key];?></td>
                    <td><?=$bonInfo[$key];?></td>
                    <td><?=$retragereInfo[$key];?></td>
                    <td><?=@$morningInfo[$key];?></td>
                    <td><?=@($morningInfo[$key]+$zetInfo[$key]-$retragereInfo[$key]-$bonInfo[$key]-$facturaInfo[$key]);?></td>
                    <td><?=@$eveningInfo[$key];?></td>
        ...
        for($i=(($today>2)? ($today-1):1);  $i<=(($today<$numberDays)? ($today+1):$numberDays);$i++):
            $currentDayRel = str_pad($i, 2, "0", STR_PAD_LEFT);
            $currentMonthRel= ($month<10?"0".$month:$month);
             $date = "$year-$currentMonthRel-$currentDayRel";
            $key=$year.$currentMonthRel.$i;
        ...
        <tr>
            ...
            <td><?=$retragereInfo[$key];?></td>
            <td><?=@$morningInfo[$key];?></td>
            <td <? if(($morningInfo[$key]+$zetInfo[$key]-$retragereInfo[$key]-$bonInfo[$key]-$facturaInfo[$key])<>$eveningInfo[$key]){?> style="color: red;" <?}?>>
                <?=@($morningInfo[$key]+$zetInfo[$key]-$retragereInfo[$key]-$bonInfo[$key]-$facturaInfo[$key]);?></td>
            <td><?=@$eveningInfo[$key];?></td>
